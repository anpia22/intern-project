...
const DashboardHeader = () => (
  <div className="mb-2 bg-white rounded-l-2xl">
    <div className="flex flex-col md:flex-row items-center justify-between gap-6 w-5/6 mx-auto pt-3 ml-10  ">
      ...
      <div className="flex items-center gap-4 ml-auto">
        ...
        <span className="font-medium text-black text-base">Annie</span>
    ...
    {/* Divider */}
    <hr className="my-4 border-gray-200 mx-auto" />
